...
//tady ma globalni led promenou
bool light_state = true;

uint32_t lastRead = 0;
uint32_t lastWrite = 0;

// Callback for MSC read/write/start-stop events
//!! taky pouziva callbacks pro logiku
...
void loop() {
  //delay(-1);
  //zajimave udelane BLikani pri zapisu,cteni
  neopixelWrite(LED_PIN, millis() - lastRead < 250 ? 50 : 0, millis() - lastWrite < 250 ? 50 : 0, 0);
  handleServer();
}